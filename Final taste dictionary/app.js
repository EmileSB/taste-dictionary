...
(() => {
  ...
  const KANJI = {
    ...
    salty: { char: "塩", strokes: [
      "M11.78,46.69c1.47,0.31,2.02,0.17,3.52,0.06c7.08-0.5,14.7-2.5,19.9-3.25c1.48-0.21,2.43-0.38,3.3-0.25",
      ...
      "M36.37,90.37c2.17,0.51,6.16,0.72,8.32,0.51c15.56-1.51,34.69-3.26,47.1-3.23c3.62,0.01,5.66,0.22,7.59,0.75",
    ]},
    karai: { char: "辛", strokes: [
  ...
  WORD_STROKES.savory = [
    ...
    { char: "味", strokes: WORD_STROKES.foodScience[2].strokes },
  ];
  WORD_STROKES.amaiKotoba = [
    { char: "甘", strokes: KANJI.sweet.strokes },
    { char: "い", strokes: [
    ...
    { char: "葉", strokes: [
      "M22,22.52c2.62,0.48,5.49,0.42,8.12,0.19c12.52-1.09,36.01-3.56,49.76-4.08c3.04-0.11,6-0.12,9.12,0.4",
  ...
  const TASTES = [
    {
      ...
      senses: [
        {
          ...
          body: "Taking an overly optimistic view of a situation or outlook, usually in a negative way. In this context, you pronounce 甘い the same way, but its meaning changes to a naive context.",
          examples: [
        ...
        },
        {
          n: "3",
          title: "Lenient · lax",
          body: "Not severe in judgments, evaluations, or treatments. In this context, 甘い先生 does not mean 'sweet teacher'; it means a lenient teacher.",
          examples: [
      ...
      relations: {
        ...
        extra: [
          { kind: "Scientific taste noun", term: "甘味", rj: "kanmi", lit: "sweetness", gloss: "Sweetness; the scientific noun for the sweet taste." },
          { kind: "Idiom", term: "甘い言葉", rj: "amai kotoba", lit: "sweet words", gloss: "Sweet talk; in Japanese it can imply manipulating or scamming someone, while in English it often carries the meaning of gentle talk.", linkedEntry: "amai-kotoba" },
          { kind: "Expression", term: "甘い香り。", rj: "amai kaori", lit: "sweet fragrance", gloss: "A sweet fragrance or aroma." },
        ],
      },
    },
    {
      ...
      relations: {
        ...
        extra: [
          { kind: "Scientific taste noun", term: "酸味", rj: "sanmi", lit: "sourness", gloss: "Sourness; the scientific noun for the sour taste." },
        ],
      },
    },
    {
    ...
    {
      id: "salty", en: "Salty", jp: "塩辛い", reading: "しおからい", romaji: "shiokarai", pos: "い-adjective",
      kanji: { char: "塩", on: "エン", kun: "しお", strokes: 13, radical: "土", radicalMeaning: "earth" },
      palate: { intensity: 5, note: "Conceptual map — every taste is sensed across the whole tongue.",
        examples: [
          { kj: "塩", rj: "shio", en: "salt" },
          { kj: "醤油", rj: "shōyu", en: "soy sauce" },
          { kj: "味噌", rj: "miso", en: "miso" },
          { kj: "漬物", rj: "tsukemono", en: "pickles" },
        ]},
      m1: {
        lede: "Taste on the tongue: tasting of salt or containing a lot of salt.",
        examples: [
      ...
      senses: [],
      grammar: [
        { form: "Dictionary", jp: "塩辛い", kana: "しおからい", romaji: "shiokarai", en: "is salty" },
        { form: "Past", jp: "塩辛かった", kana: "しおからかった", romaji: "shiokarakatta", en: "was salty" },
        { form: "Negative", jp: "塩辛くない", kana: "しおからくない", romaji: "shiokarakunai", en: "is not salty" },
        { form: "Neg. past", jp: "塩辛くなかった", kana: "しおからくなかった", romaji: "shiokarakunakatta", en: "was not salty" },
      ],
      relations: {
        syn: { term: "しょっぱい", rj: "shoppai", gloss: "The common everyday word for salty, especially in casual speech." },
        ant: { term: "薄味", rj: "usuaji", gloss: "Lightly seasoned or mild in flavor; the contrast to strongly salty food." },
        idiom: { term: "敵に塩を送る", rj: "teki ni shio o okuru", lit: "to send salt to one's enemy", gloss: "To help a rival when they are in difficulty." },
        extra: [
          { kind: "Scientific taste noun", term: "塩味", rj: "enmi", lit: "saltiness", gloss: "Saltiness; the scientific noun for the salty taste." },
        ],
      },
    },
    {
      ...
      senses: [
        {
          ...
          body: "In everyday Japanese, umami is spelled 旨み or 旨味, meaning ‘savory richness’ or ‘delicious flavor’. Only in food science and nutrition, umami is written as うま味 and refers specifically to the fifth basic taste.",
          examples: [
  ...
  // A full related-word entry, reachable from 塩辛い but intentionally absent
  // from the five-taste search index and footer navigation.
  const KARAI_ENTRY = {
    id: "karai", en: "Spicy / Hot", jp: "辛い", reading: "からい", romaji: "karai", pos: "い-adjective", related: true,
  ...
  const AMAI_KOTOBA_ENTRY = {
    ...
    pos: "noun phrase",
    related: true,
    meaning: "Kind, flattering, or persuasive words, often used to influence someone.",
    examples: [
      {
        jp: "彼は甘い言葉で彼女を口説いた。",
        reading: "かれ は あまい ことば で かのじょ を くどいた。",
        en: "He wooed her with sweet words.",
      },
      {
        jp: "甘い言葉にだまされないで。",
        reading: "あまい ことば に だまされないで。",
        en: "Don't be fooled by sweet talk.",
      },
    ],
    nuances: [
      "genuinely affectionate words",
      "flattering words",
      "manipulative sweet talk",
    ],
    relatedExpressions: [
      { term: "甘口", reading: "あまくち", romaji: "amakuchi", gloss: "sweet flavor; mild" },
      { term: "お世辞", reading: "おせじ", romaji: "oseji", gloss: "flattery" },
      { term: "口説く", reading: "くどく", romaji: "kudoku", gloss: "to woo, to court" },
      { term: "優しい言葉", reading: "やさしいことば", romaji: "yasashii kotoba", gloss: "kind words" },
    ],
  };
  ...
  /* Stroke order for a multi-character spelling, rendered with the same
  ...
  function entryHTML(t) {
    ...
    const senses = t.senses.map((s) => {
      ...
      return `
      <div class="sense${s.careful ? " sense--careful" : ""} reveal">
        <div class="sense__n">${esc(s.marker || s.n)}</div>
        <div>
    ...
    const extraRelations = (r.extra || []).map((x, i) => {
      const inner = `<div class="rcard__inner">
        ...
        ${x.linkedEntry ? `<span class="rcard__go">Open entry →</span>` : ""}
      </div>`;
      return x.linkedEntry
        ? `<a class="rcard rcard--link idiom reveal" data-d="${4 + i}" href="#${esc(x.linkedEntry)}" data-related-jump="${esc(x.linkedEntry)}" data-related-from="${t.id}">${inner}</a>`
        : `<article class="rcard idiom reveal" data-d="${4 + i}">${inner}</article>`;
    }).join("");
    const relations = `
      ...
      <div class="wrap">
        ...
        <header class="entry__head">
          <div class="entry__title">
            ${t.related ? `<a class="related-back reveal" href="#salty" data-jump="salty">← Back to Salty · 塩辛い</a>` : ""}
            <h2 class="entry__en reveal" id="hd-${t.id}">${esc(t.en)}</h2>
            <div class="entry__jpline reveal" data-d="1">
              <span class="entry__jp" lang="ja">${entryWord}</span>
        ...
        <div class="block sense-1">
          <div class="sense-1__text">
            <div class="dictionary-senses">
              ...
              ${t.related ? "" : `<div class="palate-under-meaning reveal" data-d="1">${palateHTML(t)}</div>`}
        ...
        <div class="block" ${t.id === "umami" || t.customWriting ? "hidden" : ""}>
          ...
          ${t.id === "salty" ? `
          <div class="write write--continuation">
            <div class="stroke-stage" data-stage="salty-karai"><div class="stroke-stage__inner"></div></div>
            <div class="write__panel">
              <span class="write__character-label">Second kanji in <span lang="ja">塩辛い</span></span>
              <div class="stroke-meta">
                ${pill("Kanji", KARAI_ENTRY.kanji.char)}
                ${pill("On", KARAI_ENTRY.kanji.on)}
                ${pill("Kun", KARAI_ENTRY.kanji.kun)}
                ${pill("Strokes", String(KARAI_ENTRY.kanji.strokes))}
                ${pill("Radical", `${KARAI_ENTRY.kanji.radical} (${KARAI_ENTRY.kanji.radicalMeaning})`)}
              </div>
              <div class="stroke-controls" data-controls="salty-karai">
                <button class="sbtn primary" data-act="play">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="6 4 20 12 6 20 6 4" fill="currentColor" stroke="none"/></svg>
                  Draw
                </button>
                <button class="sbtn" data-act="prev" aria-label="Previous stroke for 辛">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg>
                </button>
                <button class="sbtn" data-act="next" aria-label="Next stroke for 辛">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"/></svg>
                </button>
                <button class="sbtn toggle" data-act="numbers" aria-pressed="false">Numbers</button>
              </div>
              <div class="buildup">
                <div class="buildup__label">Stroke by stroke</div>
                <div class="buildup__row" data-build="salty-karai"></div>
              </div>
            </div>
          </div>` : ""}
          </div>
  ...
  function phraseEntryHTML(t) {
    const examples = t.examples.map((ex) => `
      <article class="phrase-example">
        <div class="phrase-example__jp" lang="ja">${esc(ex.jp)}</div>
        <p><span>Reading</span>${esc(ex.reading)}</p>
        <p><span>Meaning</span>${esc(ex.en)}</p>
      </article>`).join("");
    const related = t.relatedExpressions.map((x) => `
      <article class="rcard reveal"><div class="rcard__inner">
        <span class="kind">Related expression</span>
        <div class="term" lang="ja">${esc(x.term)}</div>
        <div class="rj">${esc(x.reading)} · ${esc(x.romaji)}</div>
        <p class="gloss">${esc(x.gloss)}</p>
      </div></article>`).join("");
    return `
    <section class="entry phrase-entry" data-taste="sweet" id="${t.id}" aria-labelledby="hd-${t.id}">
      <div class="entry__watermark" aria-hidden="true"><span lang="ja">言</span></div>
      <div class="wrap">
        <header class="entry__head">
          <div class="entry__title">
            <a class="related-back reveal" href="#sweet" data-jump="sweet">← Back to Sweet · 甘い</a>
            <h2 class="entry__en reveal" id="hd-${t.id}">${esc(t.en)}</h2>
            <div class="entry__jpline reveal" data-d="1">
          ...
          <div class="entry__glyph" lang="ja" aria-hidden="true">言</div>
        </header>

        <div class="block">
          <div class="sense sense--primary reveal">
            <div class="sense__n">2</div>
            <div>
              <span class="sense__label">Meaning 2</span>
              <h4>Sweet talk</h4>
              <p class="lede">${esc(t.meaning)}</p>
              <div class="primary-examples phrase-examples">
                <span class="note-label">Example sentences</span>
                ${examples}
              </div>
            </div>
          </div>
        ...
        <div class="block phrase-nuance">
          <div class="block__head"><span class="step">!</span><div><h3>Nuance</h3><span class="sub">meaning depends on context</span></div></div>
          <div class="phrase-nuance__panel reveal">
            <p><span lang="ja">甘い言葉</span> can be:</p>
            <ul>${t.nuances.map((n) => `<li>${esc(n)}</li>`).join("")}</ul>
            <p>The exact meaning depends on the context.</p>
          </div>
        </div>

        <div class="block phrase-writing">
          ${wordWritingHTML("amaiKotoba", t.jp)}
        </div>

        <div class="block">
          <div class="block__head"><span class="step">+</span><div><h3>Related expressions</h3><span class="sub">words often used nearby</span></div></div>
          <div class="relations phrase-relations">${related}</div>
        </div>
      </div>
    </section>`;
  }
  ...
  function mount() {
    ...
    const mountWritingWidget = (key, k) => {
      const stage = document.querySelector(`.stroke-stage[data-stage="${key}"]`);
      const controls = document.querySelector(`[data-controls="${key}"]`);
      const buildup = document.querySelector(`[data-build="${key}"]`);
      if (!stage || !controls || !buildup) return null;
      const player = buildPlayer(stage, k.strokes);
      stage._player = player;
      buildBuildup(buildup, k.strokes);
    ...
    TASTES.forEach((t) => {
      const k = KANJI[t.id];
      const player = mountWritingWidget(t.id, k);
      t._player = player;
      mountTongue(document.querySelector(`.palate[data-palate="${t.id}"]`), t);
    });
    mountWritingWidget("salty-karai", KANJI.karai);
    mountWritingWidget("karai", KANJI.karai);
  ...
  function initSearch() {
    ...
    function search(qRaw) {
      const q = norm(qRaw);
      if (!q) return [];
      const hasJapanese = /[ぁ-んァ-ン㐀-鿿]/.test(q);
      const scored = index.map((ix) => {
        ...
        for (const tok of ix.tokens) {
          ...
          else if (!hasJapanese && nt.includes(q)) score = Math.max(score, 1);
        }
    ...
    function jumpToRelated(id, fromId) {
      const entry = RELATED_ENTRIES.find((item) => item.id === id);
      const sec = entry ? document.getElementById(id) : null;
      if (!entry || !sec) return;
      const origin = TASTES.find((t) => t.id === fromId) || TASTES.find((t) => t.id === "sweet");
      close();
      document.body.classList.add("has-results", "has-matches");
      TASTES.forEach((t) => {
        const section = document.getElementById(t.id);
        if (section) section.hidden = true;
      });
      RELATED_ENTRIES.forEach((item) => {
        const section = document.getElementById(item.id);
        if (section) section.hidden = item.id !== id;
      });
      sec.hidden = false;
      if (resultsTitle) resultsTitle.textContent = "Related dictionary entry";
      if (resultsSummary) resultsSummary.textContent = `${entry.jp} (${entry.reading}) · linked from ${origin.en} (${origin.jp})`;
      const back = sec.querySelector(".related-back");
      if (back) {
        back.href = `#${origin.id}`;
        back.dataset.jump = origin.id;
        back.textContent = `← Back to ${origin.en} · ${origin.jp}`;
    ...
    document.addEventListener("click", (e) => {
      const relatedJump = e.target.closest('a[data-related-jump]');
      if (relatedJump) {
        e.preventDefault();
        return jumpToRelated(relatedJump.dataset.relatedJump, relatedJump.dataset.relatedFrom);
      }
